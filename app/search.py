...
# ------------------- Синхронный парсинг книг -------------------
def parse_books(query=None, max_results=20):
    """Google Books API parse"""
    ...
    # Сохраняем только если это полная загрузка
    if query is None:
...
def clean_books():
    ...
    try:
        ...
        # опционально: убрать книги без обложки
...
# ------------------- Тестирование парсера и очистки -------------------
